      ...
      {mode === 'wysiwyg' ? (
        ...
        <>
          {!showPreview ? (
            <textarea
              ref={markdownRef}
              className="flex-1 p-5 font-mono text-sm leading-relaxed border-none outline-none resize-none bg-gray-50 text-gray-800 w-full focus:bg-white"
